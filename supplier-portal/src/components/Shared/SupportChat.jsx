                ...
                {isOpen && (
                    ...
                    >
                        ...
                        {!isLoggedIn ? (
                            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-6 bg-gradient-to-b from-slate-50/50 to-white/50">
                                ...
                                <div className="space-y-2">
                                    <h4 className="font-black text-slate-900 text-lg tracking-tight">Support Dédié</h4>
                                    <p className="text-slate-500 text-sm font-medium max-w-xs">Veuillez vous connecter pour discuter avec l'administration.</p>
                                </div>
                            </div>
                        ) : (
                            <div
                                            ...
                                            <div className={`max-w-[85%] px-4 py-3 sm:px-5 sm:py-4 rounded-[1.5rem] shadow-sm ${
                                                ...
                                                {!isMe && msg.sender?.role === 'admin' && (
                                                    <div className="flex items-center gap-1 mb-2">
                                                        ...
                                                        <p className="text-[9px] uppercase font-black text-indigo-500 tracking-widest">Support Admin</p>
                                                    </div>
                                                )}
                        ...
                        <div className="p-4 sm:p-6 bg-white shrink-0 border-t border-slate-50">
                            <div className="flex items-center gap-2 bg-slate-50 p-2 rounded-[2rem] border border-slate-100 focus-within:border-indigo-500/30 transition-all">
                                <input
                                    type="text"
                                    value={input}
                                ...
                                <button
                                    onClick={handleSend}
                                    className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-600 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/25 hover:scale-105 active:scale-95 transition-all"
                                >
                                    <Send size={18} />
                                </button>
                            </div>
