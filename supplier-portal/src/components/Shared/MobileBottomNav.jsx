...
const MobileBottomNav = () => {
    ...
    return (
        ...
        >
            <div className="mx-4 mb-6 bg-slate-900/90 backdrop-blur-2xl border border-white/10 shadow-2xl rounded-[2.5rem] p-2 flex items-center justify-around text-white">
                {items.map((item, idx) => (
                    <NavLink
                        key={idx}
                        to={item.to}
