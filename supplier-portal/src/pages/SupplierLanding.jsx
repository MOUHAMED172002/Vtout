...
import { Package, TrendingUp, ShieldCheck, ChevronRight, Store, DollarSign, Rocket, BarChart3, Globe2 } from 'lucide-react';
                ...
                <section className="relative px-6 py-24 md:py-36 overflow-hidden flex flex-col items-center justify-center text-center bg-white">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-8 pt-12 border-t border-slate-50">
                            ...
                            <div className="text-center">
                                <p className="text-2xl font-black text-slate-900 tracking-tighter">0 FCFA</p>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Frais d'entrée</p>
                            </div>
                            <div className="w-px h-8 bg-slate-100"></div>
                            <div className="text-center">
