 ...
 * Commission is deducted from the supplier price, it does not increase the public price.
 */
...
/**
 * Reverses the public price to find the supplier price based on delivery fee tiers.
 */
