...
export default function AddressSelector({
  ...
  // échapper à l'overflow-hidden des cartes animées qui l'englobent (ex:
  // gestion d'adresses, inscription vendeur) — on calcule sa position
  // manuellement à partir du champ de recherche.
        ...
        {selectedLocation ? (
          ...
          <div className="relative" ref={inputBoxRef}>
            ...
            {/* Rendue en portail (document.body) pour échapper à l'overflow-hidden
                des cartes animées qui englobent ce composant — sinon la liste est
                mal empilée par rapport aux boutons suivants (ex: écran vendeur). */}
