      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-center mb-20">
          <motion.div 
            ...
            className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-slate-50 border border-slate-100 text-slate-400 text-[10px] font-black uppercase tracking-[0.3em] mb-4"
          >
        ...
        <motion.div 
          ...
          className="relative bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white shadow-2xl overflow-hidden mb-16"
        >
          ...
          <div className="relative z-10 space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/10 pb-10">
              ...
              <div className="px-6 py-2 bg-white/5 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-widest text-white/40">
            ...
            <div className="space-y-8 font-medium text-white/70 leading-relaxed text-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-4 hover:bg-white/10 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-slate-100">
          <div className="space-y-6">
            <h3 className="text-2xl font-black text-slate-900 tracking-tight">Utilisation des Cookies</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-black text-slate-900 tracking-tight">Sécurité des Paiements</h3>
            <p className="text-slate-500 font-medium leading-relaxed">
        ...
        <div className="mt-24 text-center">
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-6">Besoin d'aide supplémentaire ?</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button 
              onClick={() => window.location.href = 'mailto:privacy@vtout.com'}
              className="px-10 py-5 bg-slate-900 text-white rounded-full font-black text-xs uppercase tracking-widest hover:bg-primary transition-all flex items-center gap-3"
            >
