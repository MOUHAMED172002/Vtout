...
const NotificationCenter = () => {
    ...
    const getIcon = (type) => {
        ...
        if (isSeller) return <div className="p-2 bg-amber-100 text-amber-600 rounded-lg"><Store size={16} /></div>;
        if (isDelivery) return <div className="p-2 bg-emerald-100 text-emerald-600 rounded-lg"><Truck size={16} /></div>;
        if (isWallet) return <div className="p-2 bg-green-100 text-green-600 rounded-lg"><Wallet size={16} /></div>;

        switch (type) {
            case 'order': return <div className="p-2 bg-indigo-100 text-indigo-600 rounded-lg"><ShoppingBag size={16} /></div>;
            default: return <div className="p-2 bg-slate-100 text-slate-600 rounded-lg"><Bell size={16} /></div>;
        }
    };

    return (
        /* Hidden on mobile (sm:flex) to save header space */
                    ...
                    <>
                        ...
                        <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 pointer-events-none">
                            <motion.div
                                ...
                                className="pointer-events-auto w-full max-w-[500px] bg-white rounded-[2.5rem] shadow-[0_20px_70px_rgba(0,0,0,0.3)] border border-slate-100 flex flex-col max-h-[85vh] overflow-hidden"
                            >
                                {/* Header */}
