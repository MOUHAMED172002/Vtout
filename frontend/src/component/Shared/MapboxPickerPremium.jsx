                        ...
                        >
                            <div className="px-10 py-8 border-b flex items-center justify-between bg-white relative z-20">
                                <div className="flex items-center gap-5">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-black text-slate-900 tracking-tighter">Localisation Boutique</h3>
                                        <p className="text-sm text-slate-400 font-bold uppercase tracking-widest text-[10px]">Pointez précisément le siège de votre enseigne</p>
                                    </div>
                                </div>
