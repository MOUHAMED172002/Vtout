...
const PortalSwitcher = () => {
    ...
    allPortals.push({
        ...
        name: 'Acheteur',
        icon: ShoppingBag,
        url: window.location.host.includes('vendeur') ? MAIN_SITE_URL : '/', 
                    ...
                    >
                        ...
                        <div className="p-4 border-t border-base-content/5 shrink-0">
                            <button
                                ...
                                className="w-full flex items-center gap-4 px-4 py-4 rounded-2xl hover:bg-base-200 transition-all group text-left"
                            >
                                <div className="p-3 rounded-2xl transition-transform group-hover:scale-110 bg-base-200 text-base-content/50">
