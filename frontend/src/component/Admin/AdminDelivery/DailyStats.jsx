        ...
        <div className="space-y-8 animate-in fade-in duration-700 pb-20">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        onClick={fetchStats}
                        className="p-4 bg-white text-slate-600 rounded-2xl border border-slate-100 shadow-sm hover:bg-slate-50 transition-all"
                    >
                ...
                {loading && stats.length === 0 ? (
                    ...
                    <div key={s.delivery_person_id} className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-primary/5 transition-all group">
                        <div className="flex items-start justify-between mb-6">
                            <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-400 group-hover:bg-primary group-hover:text-white transition-colors duration-500 mb-4">
                                <User size={28} />
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-[10px] font-black uppercase text-slate-400">Volume Livraison</span>
