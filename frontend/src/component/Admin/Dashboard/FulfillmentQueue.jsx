                ...
                <div className="grid grid-cols-1 gap-4">
                    {orders.map((order, idx) => (
                        <motion.div
                            ...
                            className="group bg-white p-5 rounded-3xl border border-slate-100 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all flex items-center justify-between"
                        >
