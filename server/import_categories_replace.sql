...
('Ordinateurs de bureau',         2, 2),
('Imprimantes',                   2, 3),
('Routeurs & Réseau',             2, 4),
('Stockage (SSD, HDD, Clés USB)', 2, 5),
('Composants PC',                 2, 6),
('Accessoires informatiques',     2, 7),
('Gaming',                        2, 8);
...
('Pièces moto',              9, 2),
('Pneus',                    9, 3),
('Huiles & Lubrifiants',     9, 4),
('Accessoires auto',         9, 5),
('Accessoires moto',         9, 6),
('Équipements de sécurité',  9, 7);

-- Sport & Loisirs (10)
INSERT INTO categories (name, parent_id, display_order) VALUES
('Équipements de sport',  10, 1),
('Fitness & Musculation', 10, 2),
('Football',              10, 3),
('Cyclisme',              10, 4),
('Camping & Plein air',   10, 5),
