...
dotenv.config({ path: 'c:/Users/Afiss/Documents/eshop/server/.env' });

import { Product, ProductImage, ProductVariant, ProductVariantPrice, SupplierProduct, Category } from '../server/models/index.js';

async function main() {
    try {
        const id = '91954dad-2920-4e3e-97e6-9b2fbb41cbf1';
        console.log('Querying product with config:', id);
